        ...
        try:
            ...
            if n:
                ...
                st.warning(
                    ...
                    "Check that the published Google Sheet contains the current Ticker and Price rows."
                )
        except Exception as e:
